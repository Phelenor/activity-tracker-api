// Code generated by "enumer -type=ActivityType -json -text -output activitytype_string.go -trimprefix ActivityType -transform snake-upper"; DO NOT EDIT.
...
// MarshalText implements the encoding.TextMarshaler interface for ActivityType
func (i ActivityType) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for ActivityType
func (i *ActivityType) UnmarshalText(text []byte) error {
	var err error
	*i, err = ActivityTypeString(string(text))
	return err
}
